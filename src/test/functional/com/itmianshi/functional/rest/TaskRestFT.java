 ...
 *******************************************************************************/
package com.itmianshi.functional.rest;
...
import com.itmianshi.entity.Task;
import com.itmianshi.functional.BaseFunctionalTestCase;
...
import com.itmianshi.data.TaskData;
...
public class TaskRestFT extends BaseFunctionalTestCase {
	...
	public void listTasks() {
		...
		Assertions.assertThat(tasks.get(0).getTitle()).isEqualTo("Study PlayFramework 2.0");
	}
